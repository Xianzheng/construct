...
class table1(models.Model):
    ...
    开机时间= models.DateTimeField(default = 0.0,verbose_name = '开机时间',blank = True)
    关机时间= models.DateTimeField(default = 0.0,verbose_name = '关机时间',blank = True)
    操作时间= models.FloatField(default = 0.0,verbose_name = '操作时间',blank = True)
