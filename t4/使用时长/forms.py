...
class table1_Form(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
                    '设备编号': forms.TextInput(attrs={'id':'使用时长_设备编号id','list':'使用时长_设备编号','onchange':'func1(this.value)'}),
                    '设备名称': forms.TextInput(attrs={'id':'使用时长_设备名称id','list':'使用时长_设备名称','onchange':'func2(this.value)'}),
