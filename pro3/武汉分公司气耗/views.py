...
def table1_view(request):
    ...
    try:
        ...
        return render(request,renderFile,{'modelName':modelName,
                    ...
                    'goback':'/logout/','nextLayout':'/'+rootFilePath+'/'+nextModleName,'appName':'武汉分公司气耗'})
    except:
        renderFile = './table/renderTable1.html'  
        return render(request,renderFile,{'modelName':modelName,
                    'headerAndWidth':'',
...
def table2_view(request,tableId):
    ...
    try:
        ...
        return render(request,renderFile,
                    ...
                    'nextLayout':'/'+rootFilePath+'/'+nextModleName,'appName':'武汉分公司气耗'})
    except:
        renderFile = './table/renderTable1.html'  
        return render(request,renderFile,
                    {'headerAndWidth':[],
...
def addSubTable_view(request,tableId,tableModel):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if tableId == '0':
                return redirect('/武汉分公司气耗/'+rd+'/')
            return redirect('/武汉分公司气耗/'+rd+'/'+tableId)
    else:
    ...
    'tableName':title,'goback':goback,'appName':'武汉分公司气耗'})
...
def updateRow_view(request,modelName,rowId,tableId):
    ...
    'tableId':tableId,'action':action,'goback':goback,'appName':'武汉分公司气耗'})
